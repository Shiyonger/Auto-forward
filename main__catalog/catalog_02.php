...
<head>
    ...
    <link href="<?=SITE_TEMPLATE_PATH?>/css/catalogstyle.css" rel="stylesheet"/>
</head>
<body>
...
<div class="page">
    ...
    <section class="auto__light__section">
        <div class="auto__light__container">
            ...
            <div class="search__two">
                <p class="search__two__text">Светодиоды ДИАЛУЧ</p>
                <img class="search__two__img" src="<?=SITE_TEMPLATE_PATH?>/img/tick_03.png">
            </div>
        </div>
    </section>
